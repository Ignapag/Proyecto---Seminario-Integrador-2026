      ...
      <div className="bg-white max-w-[348px] w-full rounded-3xl shadow-monu overflow-hidden">
        ...
        <div className="px-8 pb-8 pt-6">
          <div className="text-center mb-6">
            ...
            <p className="text-[13px] text-gray-500">Completá tus datos para empezar a pedir.</p>
          </div>
          ...
          <div className="mt-5 text-center text-[13px]">
            <p className="text-gray-600">
              ¿Ya tenés cuenta? <Link to="/login" className="text-[#a83311] font-bold hover:underline">Iniciá Sesión</Link>
            </p>
          </div>
        </div>
      </div>
