...
import { MisPedidosIcono } from "./components/Seguimiento/MisPedidosIcono";
import { MisPedidosDrawer } from "./components/Seguimiento/MisPedidosDrawer";
...
const productoDePrueba: Producto = {
  ...
  ingredientesOpcionales: [
    { id: "o1", nombre: "Bacon", costoAdicional: 900, activo: true, enStock: true },
    { id: "o2", nombre: "Cheddar extra", costoAdicional: 500, activo: true, enStock: true },
  ],
};
    ...
    <div className="min-h-screen bg-crema">
      <header className="flex items-center justify-between px-4 py-4 max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-2">
          <MisPedidosIcono onClick={() => setPedidosAbierto(true)} />
      ...
      <MisPedidosDrawer abierto={pedidosAbierto} onCerrar={() => setPedidosAbierto(false)} />
    </div>
  );
}
